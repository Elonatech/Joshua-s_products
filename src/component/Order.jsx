    ...
    <div className="order-summary">
      ...
      <div className="summary-item">
        ...
        <span className="price">
          <FaNairaSign /> {totalPrice.toLocaleString()}
        </span>
      </div>
      <div className="summary-item">
        <span>Delivery fees</span>
        <span className="price">
          <FaNairaSign /> {deliveryFees.toLocaleString()}
        </span>
      </div>
      <div className="summary-item">
        <span>Customs fee</span>
        <span className="price">
          <FaNairaSign /> {customsFee.toLocaleString()}
        </span>
      </div>
      <div className="summary-total">
        <span>Total</span>
        <span className="price">
          <FaNairaSign /> {grandTotal.toLocaleString()}
        </span>
      </div>
